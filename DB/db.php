...
class ResultSemester {
    ...
    public $_ca_2 = "ca_2";
    public $_ca_3 = "ca_3";
    public $_lab_marks = "lab_marks";
    public $_internal_marks = "internal_marks";
    public $_obtained_credit = "obtained_credit";
    public $_obtained_grade = "obtained_grade";
...
// Result Semester Table Table Variables Definations
{
    ...
    $_resultLabMarks = $_resultSemesterObject->_lab_marks;
    $_resultInternalMarks = $_resultSemesterObject->_internal_marks;
    $_resultObtainedCredit = $_resultSemesterObject->_obtained_credit;
    $_resultObtainedGrade = $_resultSemesterObject->_obtained_grade;
