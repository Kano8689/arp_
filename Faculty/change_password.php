...
if (isset($_POST['updatePassword'])) {
    ...
    if ($newPassword == $confirmPassword) {
        if($oldPassword != $newPassword){
            ...
            $updatePassword = "UPDATE $_loginTable SET $_loginPassword = '$encPas' WHERE $_loginUsername='$loginFullId' and $_loginUserType='3'";
            $ret = mysqli_query($conn, $updatePassword);
    
            $UpdateDetailsPassword = "UPDATE $_facultyTable SET $_facultyPassword='$encPas' WHERE $_facultyCode='$facLgnId'";
    ...
    <div style="position:fixed; top:55%; left:55%; transform:translate(-50%, -50%);">
      ...
      <select id="userType" name="userType" required style="width:100%; margin-bottom:15px;">
        ...
        <option value="Student">Student</option>
            ...
            <input type="text" id="loginId" name="loginId" value="<?php echo $facLgnId . $defaultLoginExtension; ?>" placeholder="Login Id or Enrollment No" required style="width:100%; margin-bottom:15px;" readonly>
