...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <?php if ($loginType == 1) { ?>
            ...
            <!-- <a href="mapping.php" class="<?= $currentPage == '  mapping.php' ? 'active' : '' ?>">Mapping</a> -->
        ...
        <!-- CEO Panel -->
        <?php if ($loginType == 2) { ?>
            <a href="student_result.php" class="<?= $currentPage == 'student_result.php' ? 'active' : '' ?>">Student
                Result</a>
            <a href="faculty_permissions.php"
                class="<?= $currentPage == 'faculty_permissions.php' ? 'active' : '' ?>">Freeze / Unfreeze</a>
            <a href="change_password.php" class="<?= $currentPage == 'change_password.php' ? 'active' : '' ?>">Change
                Password</a>
        <?php } ?>
        ...
        <?php if ($loginType == 3) { ?>
            ...
            <!-- <a href="result.php" class="<?= $currentPage == 'result.php' ? 'active' : '' ?>">Result</a> -->
            <a href="change_password.php" class="<?= $currentPage == 'change_password.php' ? 'active' : '' ?>">Change
                Password</a>
        <?php } ?>
