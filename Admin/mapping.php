...
$_mappingTable = $_mappingTableObject->_tableName;
$_mapId = $_mappingTableObject->__id;
$_stuId = $_mappingTableObject->_stu_id;
$_facId = $_mappingTableObject->_fac_id;
$_crseId = $_mappingTableObject->_course_id;
$_sltId = $_mappingTableObject->_slot_id;
$_slotYear = $_mappingTableObject->_slot_year;
$_semesterType = $_mappingTableObject->_semester_type;
$_createdAt = $_mappingTableObject->_created_at;
$_updatedAt = $_mappingTableObject->_updated_at;
...
$redirectUrl = "mapping.php?page=$currentPage&limit=$currentLimit";
...
<div class="container">
    ...
    <div class="card">
        ...
        <div id="filterBox"
            ...
            <form method="GET" action="mapping.php">
                <div style="display:flex; flex-wrap: wrap; gap: 10px;">
                    ...
                    <select name="filter_student" style="flex:1; padding:10px;">
                        ...
                        while ($row = mysqli_fetch_assoc($studentsRes)) {
                            ...
                            echo "<option value='{$row[$_studentName]}' $selected>{$row[$_studentName]}</option>";
                        }
                        ?>
                    </select>
            ...
            <table class="table" style="margin-top:15px;">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;">Year Admit</th>
                        ...
                        <th style="text-align: center;">Practicle</th>
                ...
                while ($row = mysqli_fetch_assoc($mappingRes)) { ?>
                    <tr>
                        ...
                        <!-- <td style="text-align: center;"><?php echo $row[$_mapId]; ?></td> -->
                        <td style="text-align: center;"><?php echo GetStudentDetails($_studentCode, $row[$_stuId]); ?></td>
                        <td style="text-align: center;"><?php echo GetStudentDetails($_studentName, $row[$_stuId]); ?></td>
                        <td style="text-align: center;">
                            <?php echo GetProgramNameId(GetStudentDetails($_studentProgram, $row[$_stuId])); ?>
                        </td>
                        <td style="text-align: center;"><?php echo GetStudentDetails($_studentAdmitYear, $row[$_stuId]); ?>
                        </td>
                        <td style="text-align: center;"><?php echo GetFacultyNameId($row[$_facId]); ?></td>
                        ...
                        <td style="text-align: center;"><?php echo $course_typ; ?></td>
                        <td style="text-align: center;">
                            <?php echo GetCourseDetails($_courseTheoryMarksField, $row[$_crseId]); ?>
                        </td>
                        <td style="text-align: center;">
                            <?php echo GetCourseDetails($_coursePracticalMarksField, $row[$_crseId]); ?>
                        </td>
                        <td style="text-align: center;">
                            <?php echo GetCourseDetails($_courseCreditMarksField, $row[$_crseId]); ?>
                        </td>
                        ...
                        <td style="text-align: center; padding: 5px 0;">
                            <form method="POST">
                                ...
                                <!-- Delete button -->
                                <a href="mapping.php?del_id=<?php echo $row[$_mapId]; ?>&page=<?php echo $currentPage; ?>&limit=<?php echo $currentLimit; ?><?php echo $filterQuery; ?>"
